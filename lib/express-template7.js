...
class ExpressTemplate7 {
    constructor(config) {
        this.getTemplates = function (dirPath, options) {
            options || (options = {});
        ...
        this.resolveLayoutPath = function (layoutsDir, layoutPath, extname) {
            if (!layoutPath) {
                return null;
            }
    ...
    renderView(viewPath, options, callback) {
        ...
        this.render(viewPath, context, options, _this)
            ...
            if (layoutPath) {
                return _this.render(layoutPath, Object.assign({}, context, { body: body }), Object.assign({}, options, { layout: undefined }), _this);
            }
            return body;
        })
...
exports.ExpressTemplate7 = ExpressTemplate7;
